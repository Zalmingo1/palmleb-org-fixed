...
async function updateTest7PasswordPalmlebanon() {
  try {
    ...
    console.log('Updating password for test7@example.com in palmlebanon database');
...
updateTest7PasswordPalmlebanon(); 