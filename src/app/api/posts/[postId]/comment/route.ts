...
export async function POST(
  ...
  try {
    console.log('Comment API called with params:', params);
    ...
    if (!user) {
      ...
      // Use the name from the auth token if available
      const fullName = authUser.name || 'Anonymous User';
      ...
      console.log('Created comment with fallback name:', comment);
