...
export default function NewSuperAdminAnnouncementPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mt-4">Create New System Announcement</h1>
        <p className="text-gray-600 mt-2">Create an announcement that will be visible to all members across the system.</p>
      </div>
