...
export default function EditDistrictAdminAnnouncementPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mt-4">Edit District Announcement</h1>
