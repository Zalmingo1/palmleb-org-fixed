...
export default function EditLodgeAnnouncementPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      if (user.primaryLodge && user.primaryLodge._id) {
        setUserLodgeId(user.primaryLodge._id);
      }
    }
    fetchAnnouncement();
  }, [id]);
  ...
  const fetchAnnouncement = async () => {
    try {
      ...
      // Check if the announcement belongs to the user's lodge
      if (data.lodgeId !== userLodgeId) {
